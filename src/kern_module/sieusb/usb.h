...
#define PRODUCT			"PlayStation\xc2\xaeVR"

// AUTHENTICATION_INTERFACE #0
#define AUTHENTICATION_INTERFACE_CLASS	0x03
#define AUTHENTICATION_INTERFACE_NAME	"PS VR Control"
